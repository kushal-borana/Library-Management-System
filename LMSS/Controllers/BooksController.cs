...
namespace LMSS.Controllers
{
    public class BooksController : Controller
    {
        ...
        public BooksController(LibraryManagementSystemContext context, IAccountRepo accountsRepo)
        {
            _context = context;
        ...
        public async Task<IActionResult> BookView(string searchstring) { 
            ...
            if (!string.IsNullOrEmpty(searchstring)) { 
                ...
                b.Category.Contains(searchstring) || b.BookTitle.Contains(searchstring)).Include(b => b.Author).Include(b => b.Publisher); 
            } 
